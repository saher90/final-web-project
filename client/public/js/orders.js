$(document).ready(function() {
    ...
    $.get('./load-orders', function(res, status) {
        ...
        $.each(res, function(index, data) {
            ...
            <div class="large-detals-box" id="${data._id}">
                <div class="user-detal-box">
            ...
            $.each(data.orders, function(index, order) {
                $(`#${data._id}`).append(`<div class="order-detal-box">
            ...
            $(`#${data._id}`).append(` <button type="button" id="btn-close">Close</button>`)
            console.log($(data._id))
        })

        $(".large-detals-box").hide()
    ...
    $(document).on('click', '#btn-show', function() {
        console.log(`${$(this).closest(".flex-row.order-container").html()}`)
        $(this).closest(".flex-row.order-container").find(".large-detals-box").show()
    })
    $(document).on('click', '#btn-close', function() {
        $(this).closest(".flex-row.order-container").find(".large-detals-box").hide()
    })
})